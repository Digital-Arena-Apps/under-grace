  ...
  return (
    <header className="mb-5 flex items-center justify-between gap-4 sm:mb-7">
      <div>
        ...
        <h1 className="mt-1 font-display text-3xl font-semibold leading-none text-ink dark:text-pearl sm:text-5xl">
          Under Grace
        </h1>
      </div>

      <div className="flex items-center gap-2">
        <div className="hidden rounded-full border border-white/50 bg-white/50 px-4 py-2 text-sm font-medium text-cedar shadow-innerCalm backdrop-blur dark:border-white/10 dark:bg-white/10 dark:text-shell sm:block">
